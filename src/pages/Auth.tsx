...
const AppleIcon = () => (
  <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M17.05 20.28c-.98.95-2.05.88-3.08.4-1.09-.5-2.08-.48-3.24 0-1.38.62-2.95.38-4.04-.62C3.54 16.56 2.5 11.52 5.3 8.42c1.62-1.78 4.1-2.46 6.35-1.58.65.25 1.22.58 1.72.58.63 0 1.85-.72 2.8-.72 1.35 1.02 1.82 1.66 2.58 3.02-2.2 1.05-2.68 4.01-1.24 5.58.65.76 1.45 1.2 2.14 1.58-.5 1.42-.73 1.96-1.34 3.38zM15.88 4c.04 1.88-1.62 3.46-3.58 3.42-.1-1.78 1.48-3.48 3.58-3.42z" />
  </svg>
);
